 ...
 *
 * The switching itself is the shared EFUNC(hud,toggleOverlay) — this addon
 ...
 * EFUNC(hud,overlayActionModifier).
 *
 * Arguments:
 * None
 *
...
[STREAM_SUPPLY, false] call EFUNC(hud,toggleOverlay);

private _on = STREAM_SUPPLY in EGVAR(hud,activeStreams);
