...
// Deferred until CBA_settingsInitialized — reading a setting straight from
// postInit races the server→client settings sync, and GVAR(enable) is Global,
// so every machine must agree before either receiver goes up.
