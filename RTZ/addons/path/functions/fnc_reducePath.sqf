...
/*
 * Author: Maxim
 * Resamples a drawn path down to what the executor can actually use, keeping
 * its corners.
 *
 * A path is drawn dense and executed sparse. The fine sampling exists so the
 ...
 * commit, per unit. A 400-point infantry path typically leaves here as thirty
 * or forty.
 *
...
// it — a path must end where it was drawn to end, whatever the resampling says.
