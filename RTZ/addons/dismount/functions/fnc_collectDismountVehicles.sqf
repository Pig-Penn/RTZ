...
/*
 * Author: Maxim
 * Resolves a Zeus selection to the vehicles this component can actually act on:
 * EFUNC(common,collectVehicles) (a selected man resolves to the vehicle he is in,
 * a selected vehicle is itself) minus static weapons, which have no cargo to hold
 * in place and no bail-out behaviour to suppress.
 *
 ...
 *
 * Example:
 * [_objects + [_hoveredEntity]] call rtz_dismount_fnc_collectDismountVehicles
 *
 * Public: No
 */
