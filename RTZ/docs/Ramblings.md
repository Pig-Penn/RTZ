...
1. Would like to incorporate Zeus Wargame's cover system into my mod.
...
5. Port CSAT Modification Project's assets into this mod.
6. See if porting CSAT Marine assets is viable.
